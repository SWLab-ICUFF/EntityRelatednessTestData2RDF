package uff.ic.swlab.dataset_ertd.model;
...
public class DB {
    ...
    public static class Entity {
        ...
        public Entity(String label, String category) throws Exception {
            ...
            if (label == null || label.equals("")) {
                ...
                try {
                    this.localName = URLEncoder.encode(this.label, "UTF-8").replaceAll("_", "-").toLowerCase();
                    this.uri = conf.host().linkedDataNS() + "id-" + UUID.randomUUID().toString();
                } catch (UnsupportedEncodingException e) {
        ...
        public Property(String label, double score) throws Exception {
            ...
            if (!label.equals("")) {
                ...
                try {
                    ...
                    this.uri = conf.host().linkedDataNS() + this.localName;
                    this.inverseURI = conf.host().linkedDataNS() + "inverseOf_" + this.localName;
                } catch (UnsupportedEncodingException e) {
                    System.out.println(String.format("Entity error: unsupported label encoding (label -> %1s).", label));
                    throw e;
                }
    ...
    public static class EntityPair {
        ...
        private final String uri = conf.host().linkedDataNS() + localName;
    ...
    public static class Path {
        ...
        private String uri = conf.host().linkedDataNS() + localName;
    ...
    public static abstract class PathElement {
        ...
        private String localName = "id-" + UUID.randomUUID().toString();
        private String uri = conf.host().linkedDataNS() + this.localName;
